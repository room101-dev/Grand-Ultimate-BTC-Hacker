...
vg_ocl_prefix_rekey(vg_ocl_context_t *vocp)
{
	...
	int i;
		...
		// poc debug
//fprintf(stderr, "\n***PREFIX__REKEY() voc_nslots %d\n", vocp->voc_nslots);
//fdumphex(stderr, (unsigned char *) (hash1), 20);
...
// poc
	...
	if (found_delta != 0xffffffff) {
        ...
        // poc debug
//fprintf(stderr, "\n****FOUND_DELTA %d\n", found_delta );
//fdumphex(stderr, (unsigned char *) (ocl_found_out + 2), 20);
